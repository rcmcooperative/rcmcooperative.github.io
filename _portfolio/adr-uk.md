...
In collaboration with [ADR UK](http://adruk.org/), RCM Cooperative facilitated the co-creation of a set of recommended operating principles (technical and socio-technical) for research communities working with administrative data. 
...
Take a look at the [github repo we used for managing and archiving materials for this project](https://github.com/rcmcooperative/partner-ADR-UK)
